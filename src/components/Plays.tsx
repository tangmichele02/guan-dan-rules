...
const Plays: React.FC = () => {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <section>
        <h3 className="text-xl font-semibold mb-4 border-b border-gray-200 pb-2">Basic Combinations</h3>
      ...
      <section>
        ...
        {renderCardGroup([
          ...
          { rank: 'Q', suit: '♣' },
          { rank: 'Q', suit: '♠' }
        ], 'Five of a Kind (with current rank card as wild)')}
      ...
      <section>
        ...
        <ul className="space-y-3 text-gray-700">
          <li className="flex items-start">
            ...
            <div>
              <span className="font-medium">Current Rank Wildcards:</span> Can substitute for any card in combinations
            </div>
          </li>
          <li className="flex items-start">
            <span className="text-bold-red mr-2">•</span>
            <div>
              <span className="font-medium">Passing:</span> Once you pass, you cannot play again until the trick is won
            </div>
          </li>
          <li className="flex items-start">
            <span className="text-bold-red mr-2">•</span>
            <div>
              <span className="font-medium">Following:</span> Must play the same type and number of cards (unless bombing)
            </div>
          </li>
          <li className="flex items-start">
            <span className="text-bold-red mr-2">•</span>
            <div>
              <span className="font-medium">Lead After Win:</span> Winner of a trick leads the next play
            </div>
          </li>
        </ul>
      </section>
